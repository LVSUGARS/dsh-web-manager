...
A lightweight Windows desktop control panel for the official DeepSeek Harness (DSH) Web CLI. It helps users install, start, stop, inspect, and update DSH Web without manually maintaining a Node.js setup or terminal commands.
